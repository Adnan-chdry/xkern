/*
 * font9x8 - 96 printable ASCII glyphs (0x20-0x7F), 8x8 bitmaps.
 * Data only; rendering lives in font.c (9th column = spacing).
 */
#include "types.h"

const u8 font9x8_glyphs[96][8] = {
    ...
    /* 0x2F '/' */
    {0x02,0x04,0x08,0x08,0x10,0x20,0x00,0x00},
    ...
    /* 0x61 'a' */
    {0x00,0x00,0x3E,0x01,0x3F,0x21,0x3F,0x00},

    /* 0x62 'b' */
    {0x20,0x20,0x3C,0x22,0x22,0x22,0x3C,0x00},

    /* 0x63 'c' */
    {0x00,0x00,0x3E,0x20,0x20,0x20,0x3E,0x00},

    /* 0x64 'd' */
    {0x02,0x02,0x3E,0x22,0x22,0x22,0x3E,0x00},

    /* 0x65 'e' */
    {0x00,0x00,0x3C,0x22,0x3E,0x20,0x3C,0x00},

    /* 0x66 'f' */
    {0x0E,0x10,0x10,0x3C,0x10,0x10,0x10,0x00},

    /* 0x67 'g' */
    {0x00,0x00,0x3E,0x22,0x22,0x3E,0x02,0x3C},
    ...
    /* 0x71 'q' */
    {0x00,0x00,0x3E,0x22,0x22,0x3E,0x02,0x02},

    /* 0x72 'r' */
    {0x00,0x00,0x36,0x38,0x20,0x20,0x20,0x00},
    ...
    /* 0x7E '~' */
    {0x00,0x00,0x18,0x24,0x00,0x00,0x00,0x00},

    /* 0x7F DEL */
    {0x3E,0x22,0x2A,0x2A,0x2A,0x2A,0x22,0x3E}
};
